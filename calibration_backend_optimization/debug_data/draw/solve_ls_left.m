...
line1_files_lidar =  dir('../left/lines/lidar/line1_*.csv');
line2_files_lidar =  dir('../left/lines/lidar/line2_*.csv');
line3_files_lidar =  dir('../left/lines/lidar/line3_*.csv');
line4_files_lidar =  dir('../left/lines/lidar/line4_*.csv');
line1_files_camera =  dir('../left/lines/camera/camera_line1_view*.csv');
line2_files_camera =  dir('../left/lines/camera/camera_line2_view*.csv');
line3_files_camera =  dir('../left/lines/camera/camera_line3_view*.csv');
line4_files_camera =  dir('../left/lines/camera/camera_line4_view*.csv');
n = length(files_lidar);

for i = 1:n
  csv_lidar_line1 = load((strcat('../left/lines/lidar/', line1_files_lidar(i).name)));
  csv_camera_line1 = load((strcat('../left/lines/camera/', line1_files_camera(i).name)));
  csv_lidar_line2 = load((strcat('../left/lines/lidar/', line2_files_lidar(i).name)));
  csv_camera_line2 = load((strcat('../left/lines/camera/', line2_files_camera(i).name)));
  csv_lidar_line3 = load((strcat('../left/lines/lidar/', line3_files_lidar(i).name)));
  csv_camera_line3 = load((strcat('../left/lines/camera/', line3_files_camera(i).name)));
  csv_lidar_line4 = load((strcat('../left/lines/lidar/', line4_files_lidar(i).name)));
  csv_camera_line4 = load((strcat('../left/lines/camera/', line4_files_camera(i).name)));
