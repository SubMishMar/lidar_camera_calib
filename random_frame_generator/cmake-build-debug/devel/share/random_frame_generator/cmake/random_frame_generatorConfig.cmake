...
if(random_frame_generator_CONFIG_INCLUDED)
  return()
endif()
set(random_frame_generator_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(random_frame_generator_SOURCE_PREFIX /home/usl/catkin_ws/src/pbpc-cal/random_frame_generator)
  set(random_frame_generator_DEVEL_PREFIX /home/usl/catkin_ws/src/pbpc-cal/random_frame_generator/cmake-build-debug/devel)
  set(random_frame_generator_INSTALL_PREFIX "")
  set(random_frame_generator_PREFIX ${random_frame_generator_DEVEL_PREFIX})
else()
  set(random_frame_generator_SOURCE_PREFIX "")
  set(random_frame_generator_DEVEL_PREFIX "")
  set(random_frame_generator_INSTALL_PREFIX /usr/local)
  set(random_frame_generator_PREFIX ${random_frame_generator_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'random_frame_generator' is deprecated")
...
set(random_frame_generator_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/local/include/pcl-1.7;/usr/include/eigen3;//usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/serial;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  set(random_frame_generator_INCLUDE_DIRS "")
  set(_include_dirs "/usr/local/include/pcl-1.7;/usr/include/eigen3;//usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/serial;/usr/include/libxml2;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND random_frame_generator_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/usl/catkin_ws/src/pbpc-cal/random_frame_generator/cmake-build-debug/devel/lib;/home/usl/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(random_frame_generator_LIBRARY_DIRS ${lib_path})
      list(APPEND random_frame_generator_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'random_frame_generator'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND random_frame_generator_LIBRARIES ${lib})
    endif()
  endif()
...
set(random_frame_generator_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${random_frame_generator_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 random_frame_generator_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${random_frame_generator_dep}_FOUND)
      find_package(${random_frame_generator_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${random_frame_generator_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(random_frame_generator_INCLUDE_DIRS ${${random_frame_generator_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(random_frame_generator_LIBRARIES ${random_frame_generator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${random_frame_generator_dep}_LIBRARIES})
  _list_append_deduplicate(random_frame_generator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(random_frame_generator_LIBRARIES ${random_frame_generator_LIBRARIES})

  _list_append_unique(random_frame_generator_LIBRARY_DIRS ${${random_frame_generator_dep}_LIBRARY_DIRS})
  list(APPEND random_frame_generator_EXPORTED_TARGETS ${${random_frame_generator_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${random_frame_generator_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
